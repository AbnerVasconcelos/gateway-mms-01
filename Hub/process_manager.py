...
class ProcessInstance:
    ...
    async def start(self, python_path: str, gateway_dir: str) -> None:
        ...
        env['SERIAL_PORT'] = str(self.config.get('serial_port', ''))
        env['SERIAL_BAUDRATE'] = str(self.config.get('serial_baudrate', 19200))
        env['SERIAL_PARITY'] = str(self.config.get('serial_parity', 'N'))
        env['SERIAL_STOPBITS'] = str(self.config.get('serial_stopbits', 1))
